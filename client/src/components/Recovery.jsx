                ...
                <div className={styles.glass}>
                    <div className="title flex flex-col items-center">
                        ...
                        <span className="py-4 text-xl w-2/3 text-center text-gray-500">
                           Enter OTP to recover password from your email
                    </span>
                    </div>
                    <form className="py-1 flex flex-col items-center " onSubmit={formik.handleSubmit}>
                        <div className="flex flex-col items-center w-[100%]">
                            <span className="py-4 text-xl w-2/3 text-center text-gray-500">Enter 6 digit OTP sent to your email address.</span>
                                <input {...formik.getFieldProps("password")} type="text" placeholder="OTP digits"
                        ...
                        <span className="text-gray-500">
                            Forgot Password? <button  className='text-gray-500 '>Resend</button>
                        </span>
                        </div>
                    </form>
                </div>
